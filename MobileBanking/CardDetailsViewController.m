...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *optionsBtn = [[UIBarButtonItem alloc] initWithTitle:@"Statement" style:UIBarButtonItemStyleBordered target:self action:@selector(historyOption:)];
...
-(IBAction)historyOption:(id)sender{
    ...
    UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"Card Statement" message:@"Choose Statement month" delegate:self cancelButtonTitle:@"Go Back" otherButtonTitles:nil, nil];
       
    //[message addButtonWithTitle:@"March"];
    //[message addButtonWithTitle:@"April"];
    //[message addButtonWithTitle:@"May"];
    [message addButtonWithTitle:@"June"];
    [message addButtonWithTitle:@"July"];
    [message addButtonWithTitle:@"August"];
    [message show];
}
